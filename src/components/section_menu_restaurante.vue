<template>
			<!-- Section Menu -->
			<section class="section kf-menu kf-parallax" id="Restaurante" style="background-image: url(./src/assets/images/category_bg.jpg);">
				<div class="container">

					<div class="kf-titles align-center">
						<div class="kf-subtitle element-anim-1 scroll-animate" data-animate="active">
							Escolha a melhor opção do Restaurante
						</div>
