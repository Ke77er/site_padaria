				...
				<div class="container">
					...
					<div class="kf-titles align-center">
						...
						<h3 class="kf-title element-anim-1 scroll-animate" data-animate="active">
							Leia as Ultimas Noticias do Nosso Blog.
						</h3>
					</div>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
							<div class="kf-blog-grid-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="desc">
									...
									<div class="kf-date"><i class="far fa-calendar-alt"></i>25 Mar 2024</div>
									<div class="kf-comm"><i class="far fa-comments"></i>Comentários (7)</div>
								</div>
							</div>
						</div>
